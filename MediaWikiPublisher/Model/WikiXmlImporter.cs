...
namespace MediaWikiPublisher.Model
{
    public class WikiXmlImporter : IWikiImporter
    {
        ...
        private IEnumerable<WikiPageCategory> LoadPagesInternal(XElement xml, List<string> categories)
        {
            return xml
                .Elements(Xml.Page)
        ...
        private WikiPageCategory LoadPage(XElement xml, List<string> categories)
        {
            ...
            return new WikiPageCategory(id, category, title, text);
        }
